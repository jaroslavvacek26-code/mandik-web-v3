...
export const salesContacts: SalesContact[] = [
  {
    ...
    representative: 'Ing. Tomáš Novák',
    title: {
  ...
  },
  {
    ...
    divisionName: { cz: 'Český obchod', en: 'Czech Trade', de: 'Tschechischer Handel' },
    representative: 'Ing. Martin Horák',
    title: {
  ...
  },
  {
    ...
    representative: 'Ing. Jana Procházková',
    title: {
      cz: 'Export manažer',
      en: 'Export Manager',
      de: 'Export Manager',
